...
--
-- Host: localhost
-- Generation Time: Nov 25, 2009 at 11:55 PM
...
INSERT INTO `exams` (`id`, `exam_description`, `passing`, `cost`, `active`, `version`, `created_date`, `last_changed`, `created_by`) VALUES
...
--
-- Table structure for table `exams_admin`
--

CREATE TABLE IF NOT EXISTS `exams_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `exams_admin`
--

INSERT INTO `exams_admin` (`id`, `pilot_id`, `admin_level`) VALUES
(1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `exams_available`
--

CREATE TABLE IF NOT EXISTS `exams_available` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `exams_available`
--
...
--
-- Table structure for table `exams_exam_revisions`
--

CREATE TABLE IF NOT EXISTS `exams_exam_revisions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `exams_exam_revisions`
--

INSERT INTO `exams_exam_revisions` (`id`, `exam_id`, `revised_by`, `revision`, `date_revised`) VALUES
...
INSERT INTO `exams_questions` (`id`, `exam_id`, `question`, `answer_1`, `answer_2`, `answer_3`, `answer_4`, `correct_answer`, `active`) VALUES
...
--
-- Table structure for table `exams_questions_revisions`
--

CREATE TABLE IF NOT EXISTS `exams_questions_revisions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `exams_questions_revisions`
--

INSERT INTO `exams_questions_revisions` (`id`, `question_id`, `revised_by`, `revision`, `date_revised`) VALUES
(1, 29, 1, 2, '2009-11-22 00:53:06');

-- --------------------------------------------------------

--
-- Table structure for table `exams_requests`
--

CREATE TABLE IF NOT EXISTS `exams_requests` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `exams_requests`
--
...
--
-- Table structure for table `exams_results_history`
--

CREATE TABLE IF NOT EXISTS `exams_results_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `exams_results_history`
--
...
--
-- Table structure for table `exams_revisions_types`
--

CREATE TABLE IF NOT EXISTS `exams_revisions_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `exams_revisions_types`
--

INSERT INTO `exams_revisions_types` (`id`, `revision`, `deleted`, `editable`, `date_created`, `created_by`, `active`) VALUES
...
--
-- Table structure for table `exams_settings`
--

CREATE TABLE IF NOT EXISTS `exams_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `exams_settings`
--

INSERT INTO `exams_settings` (`id`, `setting`, `value`, `setting_type`) VALUES
